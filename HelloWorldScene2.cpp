...
bool HelloWorld::init()
{
	...
	do
	{
		...
		// Add text
		LabelTTF* pLabel = LabelTTF::create("PIXEL PERFECT COLLISION DETECTION", "Arial", 14);
		CC_BREAK_IF(!pLabel);
		...
		LabelTTF* pLabel2 = LabelTTF::create("Touch to move the player ship", "Arial", 14);
		CC_BREAK_IF(!pLabel2);
		...
		LabelTTF* pLabel3 = LabelTTF::create("Alignment 0\nnew line", "Helvetica", 14, Size(256, 32), TextHAlignment::LEFT, TextVAlignment::CENTER);
		CC_BREAK_IF(!pLabel3);
		...
		_rt = RenderTexture::create(winSize.width, winSize.height);
...
void  HelloWorld::tick(float dt)
{
	...
	sprintf(string, "ship rect=(%03.1f,%03.1f)-(%03.1f,%03.1f)", r1.getMinX(), r1.getMinY(), r1.getMaxX(), r1.getMaxY());
	//string.format("%2.2f Test", m_time);

	LabelTTF* label1 = (LabelTTF*)getChildByTag(kTagSprite3);
...
{
	//if (CollisionDetection::GetInstance()->areTheSpritesColliding(_ship, _enemy1, true, _rt)) 
	//{
	//	_enemy1->setColor(Color3B(255, 0, 0));
	//}
	//else
	//{
	//	_enemy1->setColor(Color3B(255, 255, 255));
	//}

	//if (CollisionDetection::GetInstance()->areTheSpritesColliding(_ship, _enemy2, false, _rt))
	//{
	//	_enemy2->setColor(Color3B(255, 0, 0));
	//}
	//else
	//{
	//	_enemy2->setColor(Color3B(255, 255, 255));
	//}
...
bool	HelloWorld::isCollisionBetweenSpriteA(cocos2d::CCSprite* spr1, cocos2d::CCSprite* spr2, bool pp)
{
